      ...
      <div id='header-wrap'>
        <div className='container clearfix'>
          ...
          <div id='logo'>
            ...
            >
              <img src={process.env.PUBLIC_URL + '/assets/images/logo.png'} alt='Canvas Logo' />
            </a>
            <a
              href='index.html'
            ...
            >
              <img src={process.env.PUBLIC_URL +'assets/images/logo@2x.png'} alt='Canvas Logo' />
            </a>
          </div>
                      ...
                      <li className="mega-menu"><a href="#"><div>Shortcodes</div></a>
                          <div className="mega-menu-content clearfix">
                              ...
                              <ul className="mega-menu-column col-5">
                                  ...
                                  <li><a href="component-typeahead.html"><div><i className="icon-type"></i>Input Typeahead</div></a></li>
                              </ul>
                          </div>
                      </li>
                  </ul>
